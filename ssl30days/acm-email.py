...
with open('/tmp/acm.csv', 'a',newline='') as file:
    ...
    writer.writerow(["Region", "Domain_Name", "CertificateArn","Status","Created","Expiry","Issuer","Useby"])
def lambda_handler(event, context):
    ...
    msg["From"] = "cynthia.uwhe@aplaceformom.com"
    msg["To"] = "cynthia.uwhe@aplaceformom.com"
    # Set message body
    body = MIMEText("Hello, This is a weekly ACM cert report !", "plain")
    msg.attach(body)
    ...
    response = ses_client.send_raw_email(
        Source="cynthia.uwhe@aplaceformom.com",
        Destinations=["cynthia.uwhe@aplaceformom.com"],
